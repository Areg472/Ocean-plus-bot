...
class MediaSelectionView(discord.ui.View):
    ...
    async def process_prompt(self, interaction: discord.Interaction, use_audio: bool):
        ...
        if model in ["deepseek-ai/DeepSeek-R1-0528-tput", "Qwen/Qwen3-235B-A22B-fp8-tput", "magistral-small-2507", "magistral-medium-2507", "openai/gpt-oss-120b", "gpt-5-nano", "gpt-5-mini", "gpt-5", "4o-mini"] and think_text:
