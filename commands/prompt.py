...
class MediaSelectionView(discord.ui.View):
    ...
    async def process_prompt(self, interaction: discord.Interaction, use_audio: bool):
        if use_audio:
            ...
            model = "mistral-small-2506" if self.model not in ["mistral-small-2506", "mistral-medium-2508", "gpt-5-nano", "gpt-5-mini", "gpt-5", "gpt-4.1", "gpt-4.1-mini", "gpt-4.1-nano", "4o-mini"] else self.model
        ...
        try:
            if model in ["deepseek-ai/DeepSeek-R1-0528-tput", "Qwen/Qwen3-235B-A22B-fp8-tput", "magistral-small-2507", "magistral-medium-2507", "openai/gpt-oss-120b", "4o-mini", "gpt-5-nano", "gpt-5-mini", "gpt-5"]:
        ...
        if model in ["deepseek-ai/DeepSeek-R1-0528-tput", "Qwen/Qwen3-235B-A22B-fp8-tput", "magistral-small-2507", "magistral-medium-2507", "openai/gpt-oss-120b", "4o-mini", "gpt-5-nano", "gpt-5-mini", "gpt-5"] and think_text:
...
MODEL_CHOICES = [
    ...
    app_commands.Choice(name="GPT 4o Mini (Thinking)", value="4o-mini"),
]
...
async def prompt_command(
    ...
    if audio:
        ...
        if model not in ["mistral-small-2506", "mistral-medium-2508", "gpt-5-nano", "gpt-5-mini", "gpt-5", "gpt-4.1", "gpt-4.1-mini", "gpt-4.1-nano", "4o-mini"]:
